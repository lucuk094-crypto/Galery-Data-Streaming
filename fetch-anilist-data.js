...
// GraphQL query to fetch anime data with complete details
const ANIME_QUERY = `
...
// Query specifically for anime with trailers - with complete details
const TRAILER_QUERY = `
...
function extractMediaData(anime) {
  // Extract all the detailed media data from AniList
  return {
    id: anime.id,
    idMal: anime.idMal,
    title: anime.title,
